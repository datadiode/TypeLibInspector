...
#AutoIt3Wrapper_OutFile=..\..\build\TypeLibInspector.exe
#AutoIt3Wrapper_Icon=..\..\res\icons\TypeLibInspector.ico
#AutoIt3Wrapper_Prompt=n
...
#AutoIt3Wrapper_Res_Field=ProductVersion|0.1.0
#AutoIt3Wrapper_Res_Field=CompanyName|diVISION
#AutoIt3Wrapper_Res_Field=LegalTrademarks|GNU/GPL
#AutoIt3Wrapper_Res_Field=InternalName|%scriptfile%
#AutoIt3Wrapper_Res_Field=Platform|2000/XP/Vista/7
...
; Description:    Comiplation headers for TypeLibInspector.
; $Revision: 1.4 $
; $Date: 2010/07/29 14:29:57 $
;
; ------------------------------------------------------------------------------
#include "App.au3"